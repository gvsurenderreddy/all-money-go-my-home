# -*- coding: utf8 -*-
# Django settings for ovpnusrmng project.
# Remember to replace the sensitive things on line 8 and 87, and save it as `settings.py`
#
